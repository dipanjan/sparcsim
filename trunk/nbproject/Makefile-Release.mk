...
${TESTDIR}/tests/testBits.o: tests/testBits.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/testBits.o tests/testBits.c


${TESTDIR}/tests/testBreakPoint.o: tests/testBreakPoint.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/testBreakPoint.o tests/testBreakPoint.c
...
${OBJECTDIR}/loader_nomain.o: ${OBJECTDIR}/loader.o loader.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/loader_nomain.o loader.c;\
	else  \
...
${OBJECTDIR}/misc_nomain.o: ${OBJECTDIR}/misc.o misc.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/misc_nomain.o misc.c;\
	else  \
...
${OBJECTDIR}/breakpoint_nomain.o: ${OBJECTDIR}/breakpoint.o breakpoint.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/breakpoint_nomain.o breakpoint.c;\
	else  \
...
${OBJECTDIR}/register_nomain.o: ${OBJECTDIR}/register.o register.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/register_nomain.o register.c;\
	else  \
...
${OBJECTDIR}/decode_nomain.o: ${OBJECTDIR}/decode.o decode.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/decode_nomain.o decode.c;\
	else  \
...
${OBJECTDIR}/memory_nomain.o: ${OBJECTDIR}/memory.o memory.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/memory_nomain.o memory.c;\
	else  \
...
${OBJECTDIR}/execute_nomain.o: ${OBJECTDIR}/execute.o execute.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/execute_nomain.o execute.c;\
	else  \
...
${OBJECTDIR}/trap_nomain.o: ${OBJECTDIR}/trap.o trap.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/trap_nomain.o trap.c;\
	else  \
...
${OBJECTDIR}/simulator_nomain.o: ${OBJECTDIR}/simulator.o simulator.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/simulator_nomain.o simulator.c;\
	else  \
...
${OBJECTDIR}/bits_nomain.o: ${OBJECTDIR}/bits.o bits.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/bits_nomain.o bits.c;\
	else  \
